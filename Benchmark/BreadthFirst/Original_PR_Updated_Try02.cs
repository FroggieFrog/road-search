...
{
    public static class Original_PR_Updated_Try02
    {
            ...
            foreach (var startObject in startObjects)
            {
                ...
                for (var i = 0; i < startSize.Width; i++)
                {
                    ...
                    if (gridDictionary.TryGetValue(x, out var xValue))
                    {
                        ...
                        {
                            searchedCells.Enqueue((rangeGetter(startObject), i + startPosition.X, y));
                            visitedCells.Add(new Point(i + startPosition.X, y));
                        }
                    }
                }
                ...
                for (var i = 0; i < startSize.Width; i++)
                {
                    ...
                    {
                        visitedCells.Add(new Point(startPosition.X + i, startPosition.Y + j));
                    }
                }
            }
